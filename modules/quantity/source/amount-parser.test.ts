import { getValueRepresentation } from "@tstst/general/source/utility";
...
describe("AmountParser", () => {
  describe("#parse", () => {
    ...
    for (const expectation of expectations) {
      ...
      it(`should return ${getValueRepresentation(expectedSimplifiedResult)} for ${getValueRepresentation(
        value
      )}`, () => {
